...
export class App {
    ...
    this.container.innerHTML = `
      <div class="header">
        <div class="header-left">
          ...
          <a href="https://github.com/frinfo702/worldmonitor-for-CS" target="_blank" rel="noopener" class="github-link" title="View on GitHub">
  ...
  private async loadAIPapers(): Promise<NewsItem[]> {
    ...
    try {
      ...
      this.statusPanel?.updateApi("OpenReview / arXiv / alphaXiv", {
        status: "ok",
      });
